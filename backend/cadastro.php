...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        header('Location: ../games/snakegame/index.php');
        exit;
    } else {
        ...
        if ($stmt_insert->execute()) {
            ...
            header('Location: ../games/snakegame/index.php?p?error=Erro ao cadastrar usuário');
            exit;
        }
        $stmt_insert->close();
    }
    ...
    header('Location: ../games/snakegame/index.php?p?error=Método inválido');
    exit;
}
?>